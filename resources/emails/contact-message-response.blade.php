...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <style @if(isset($cspNonce)) nonce="{{ $cspNonce }}" @endif type="text/css">
		p{
			margin:10px 0;
			padding:0;
		}
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
				...
				<td valign="top" width="600" style="width:600px;">
				<![endif]-->
                {!! __('translations.mails.contact_message_response.body', [
                    'full_name' => $payload['full_name'],
                    'subject' => $payload['contact_subject']['value'][app()->getLocale() ?? 'en'],
                    'message' => $payload['message'],
                    'response' => $payload['contact_responses']['message'],
    ...
    <script type="text/javascript"  src="/gV1OECZ-U58b45AewA/SiOYSGfwtmVbzOwY/MBAXdXQkBA/I30Q/TBRoCAI"></script></body>
</html>