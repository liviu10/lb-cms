...
class ContentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($currentRouteName === 'admin.management.cms.contents.store') {
            $rules = [
                'content_visibility_id' => 'required|exists:content_visibilities,id',
        ...
        if ($currentRouteName === 'admin.management.cms.contents.update') {
            $rules = [
                'content_visibility_id' => 'sometimes|exists:content_visibilities,id',
    ...
    {
        return [
            'content_visibility_id.required' => __('translations.validations.content_visibility_id.required'),
            'content_visibility_id.exists' => __('translations.validations.content_visibility_id.exists'),
